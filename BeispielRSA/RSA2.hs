...
main = do
    ...
    putStrLn ("tot: " ++ show tot ++ " e: " ++ show e)
    --putStrLn ("Test: " ++ show (decode $ rsa_decode d n [156479]))
    putStrLn ("encoded: " ++ show rsa_encoded)

    putStrLn "--- DEBUG ENDING ---"
    ---
